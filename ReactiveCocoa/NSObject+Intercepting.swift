...
extension Reactive where Base: NSObject {
	...
	/// object.  if includeReturnValue == true, then array will include any return value of the invocation, if the 'selector' returns a value.
	///
	/// It completes when the object deinitializes.
	///
	/// - note: Observers to the resulting signal should not call the method
	...
	/// - parameters:
	///   - selector: The selector to observe.
	///   - includeReturnValue:  the array wil include the value returned by the invocation.
...
private func unpackInvocation(_ invocation: AnyObject, includeReturnValue: Bool = true) -> [Any?] {
